...
// Explanation:
/*
Replacing 'let message' with a state variable, we gain access to the 'setMessage' function. When called
inside 'handleChange' it doesn't just update the string, but tells React to re-render the component so 
the UI updates with new data.
*/
